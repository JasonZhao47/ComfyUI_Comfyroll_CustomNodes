...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Aspect Ratio nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load List nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load LoRA nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load ControlNet nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Pipe nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load SDXL nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Model Merge nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Upscale nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load XY Grid nodes\033[0m")
...
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Legacy nodes\033[0m")

# Graphics Layout节点模块（包含CR Color Panel）
try:
    ...
    print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Layout nodes\033[0m")
...
#     # 添加matplot节点
# except ImportError:
#     print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Matplot nodes\033[0m")

# try:
#     from .nodes.nodes_graphics_text import *
#     # 添加text节点
# except ImportError:
#     print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Text nodes\033[0m")

# try:
#     from .nodes.nodes_graphics_filter import *
#     # 添加filter节点
# except ImportError:
#     print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Filter nodes\033[0m")

# try:
#     from .nodes.nodes_graphics_template import *
#     # 添加template节点
# except ImportError:
#     print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Template nodes\033[0m")

# try:
#     from .nodes.nodes_graphics_pattern import *
#     # 添加pattern节点
# except ImportError:
#     print("\033[34mComfyroll Studio: \033[92mFailed to load Graphics Pattern nodes\033[0m")
